...
#set hiddenimports
perl -i -pe 'BEGIN{undef $/;} s/hiddenimports=\[\],/hiddenimports=\['\"setuptools\"', '\"distutils\"', '\"cython\"', '\"requests\"', '\"watchdog\"', '\"certifi\"', '\"kivy.core.image.img_gif\"', '\"git\"'],/smg' "$DEPLOY_NAME.spec"
